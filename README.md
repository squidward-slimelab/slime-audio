...
python3 scripts/slime_audio_live_edit.py add-effect --id break-loop-reverb-tail --type reverb --target break-loop --start 01:31.500 --duration 00:02.000
