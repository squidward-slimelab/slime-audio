...
- `scripts/slime_audio_tts.py` and `scripts/slime_audio_drops.py`: prepare and deliver spoken drops.
...
- Add tasteful drops every few minutes, with silence between them.
...
- Keep commentary planning separate from the music queue so new drops can be added without restarting playback.
