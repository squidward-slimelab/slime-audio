...
class SlimeAudioSessionMixdownTests(unittest.TestCase):
    ...
    def test_mixdown_filter_renders_echo_effect_with_tail(self):
        ...
        self.assertIn("afade=t=out:st=2.000:d=3.000", filters)
    ...
    def test_mixdown_filter_renders_reverb_effect_with_tail(self):
        ...
        self.assertIn("aecho=0.45:0.380:67|79|94|115|142|175|212|259|310|367|430|503", filters)
        self.assertIn("lowpass=f=5620.000", filters)
        self.assertIn("allpass=f=540:width_type=h:width=520:mix=0.56", filters)
        self.assertIn("stereowiden=delay=18:feedback=0.08:crossfeed=0.28:drymix=0.78", filters)
        self.assertIn("afade=t=out:st=2.000:d=4.000", filters)
